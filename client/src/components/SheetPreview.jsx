    ...
    <div className="rounded-xl border border-gray-200 overflow-hidden bg-white shadow-sm">
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-gray-50 border-b border-gray-200">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-semibold text-gray-600">Google Sheets Preview</span>
        </div>
        <div className="ml-auto flex items-center gap-1">
          <div className="px-2 py-0.5 bg-green-100 rounded text-xs font-medium text-green-700">
            {partName} tab
          </div>
        </div>
      </div>
      ...
      <div className="px-3 py-1.5 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
        <span className="text-[10px] text-gray-400">Row will be appended to the end of the sheet</span>
